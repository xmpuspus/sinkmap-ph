...
def main():
    ...
    findings = [
        {
            ...
            "tag": {"en": "Metro Manila / Bulacan", "tl": "Metro Manila / Bulacan"},
            "title": {"en": "Past its peak, but the sinking is spreading wider",
                      "tl": "Lampas na sa rurok, pero mas lumalawak ang paglubog"},
            ...
            "blurb": {"en": f"The worst hotspot slowed ({hot['early_rate_mm_yr']:.0f} to {hot['late_rate_mm_yr']:.0f} mm/yr between the 2016-2020 and 2021-2025 halves), yet more ground sped up than slowed. A zone about 6 km east more than doubled, from {east['early_rate_mm_yr']:.0f} to {east['late_rate_mm_yr']:.0f} mm/yr. On the map, orange is speeding up and purple is slowing.",
                      "tl": f"Bumagal ang pinakamabilis na lugar ({hot['early_rate_mm_yr']:.0f} hanggang {hot['late_rate_mm_yr']:.0f} mm/taon sa pagitan ng 2016-2020 at 2021-2025), pero mas malaking lupa ang bumilis. Isang lugar 6 km sa silangan ang lumampas sa doble, mula {east['early_rate_mm_yr']:.0f} hanggang {east['late_rate_mm_yr']:.0f} mm/taon. Sa mapa, kahel ay bumibilis at lila ay bumabagal."},
        ...
        },
        {
            ...
            "tag": {"en": "Metro Manila", "tl": "Metro Manila"},
            "title": {"en": "Half of the fast-sinking buildings are flood-prone too",
                      "tl": "Kalahati ng mabilis lumulubog na gusali, madali ring bahain"},
        ...
        {
            "id": "footprint",
            "tag": {"en": "Central Luzon", "tl": "Gitnang Luzon"},
            "title": {"en": "The deep-sinking zone spread out from almost nothing",
                      "tl": "Kumalat ang malalim na paglubog mula sa halos wala"},
        ...
        {
            "id": "municipality",
            "tag": {"en": f"{san['name']}, Bulacan", "tl": f"{san['name']}, Bulacan"},
            "title": {"en": "One town holds the most at-risk ground",
                      "tl": "Isang bayan ang may pinakamaraming apektadong lupa"},
        ...
        },
        {
            "id": "decoupling",
            "tag": {"en": "Metro Manila", "tl": "Metro Manila"},
            "title": {"en": "The deepest floods aren't where the ground sinks fastest",
                      "tl": "Ang pinakamalalim na baha, hindi ang pinakamabilis lumubog"},
            "stat": {"en": f"most fast-sinking ground is in shallow or medium flood zones, not the deepest",
                     "tl": f"karamihan ng mabilis lumulubog ay nasa mababaw o katamtamang baha, hindi sa pinakamalalim"},
            "blurb": {"en": f"Sort the ground by how deep the modeled flood gets. Of the ground sinking faster than 10 mm a year, {pct[1]:.0f}% sits in shallow-flood areas and {pct[2]:.0f}% in medium ones, but only {pct[3]:.0f}% sits where floods are modeled to run deepest. So the places that sink fastest and the places that flood deepest mostly do not line up. They overlap, but they are largely separate maps.",
                      "tl": f"Ayusin ang lupa ayon sa lalim ng baha. Sa lupang lumulubog nang higit 10 mm kada taon, {pct[1]:.0f}% ay nasa mababaw na baha at {pct[2]:.0f}% sa katamtaman, ngunit {pct[3]:.0f}% lang ang nasa pinakamalalim. Kaya ang mabilis lumubog at ang pinakamalalim na baha ay kadalasang hindi nagtutugma. Magkasapaw, pero halos magkahiwalay na mapa."},
        ...
        },
        {
            "id": "tilt", "layer": "tilt",
            "tag": {"en": "Metro Manila", "tl": "Metro Manila"},
            "title": {"en": "It is the uneven sinking that breaks roads and pipes",
                      "tl": "Ang hindi pantay na paglubog ang sumisira ng kalsada at tubo"},
            "stat": {"en": f"the ground tilts up to {tlt['max_mm_yr_per_km']:.0f} mm/yr per km",
                     "tl": f"humihilig ang lupa hanggang {tlt['max_mm_yr_per_km']:.0f} mm/taon kada km"},
        ...
        {
            "id": "sea_vs_land",
            "tag": {"en": "Bulacan", "tl": "Bulacan"},
            "title": {"en": "The land is dropping far faster than the sea is rising",
                      "tl": "Mas mabilis bumababa ang lupa kaysa pagtaas ng dagat"},
    ...
    try:
        ...
        findings += [
            {"id": "dagupan", "tag": {"en": "Dagupan, Pangasinan", "tl": "Dagupan, Pangasinan"}, "layer": "accel-dagupan",
             "title": {"en": "The country's second fastest-sinking delta",
                       "tl": "Pangalawang pinakamabilis lumubog na delta sa bansa"},
            ...
            {"id": "regime", "tag": {"en": "Nationwide", "tl": "Buong bansa"},
             "title": {"en": "It is the river deltas that sink, not the cities",
                       "tl": "Ang mga delta ng ilog ang lumulubog, hindi ang mga lungsod"},
            ...
            {"id": "deceleration", "tag": {"en": "Nationwide", "tl": "Buong bansa"},
             "title": {"en": "Every fast-sinking hotspot is now past its peak",
                       "tl": "Lampas na sa rurok ang bawat mabilis na hotspot"},
